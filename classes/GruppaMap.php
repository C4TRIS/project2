<?php
    class GruppaMap extends BaseMap {
        ...
        public function findViewById($id = null) {
            if ($id) {
                $res = $this->db->query("SELECT gruppa.gruppa_id, gruppa.name, special.name AS special, gruppa.date_begin,
                                        gruppa.date_end" . " FROM gruppa INNER JOIN special ON gruppa.special_id=special.special_id WHERE gruppa_id = $id");
